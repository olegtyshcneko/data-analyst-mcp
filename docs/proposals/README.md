...
- [`2026-07-18-ephemeral-fit-replay-provenance.md`](2026-07-18-ephemeral-fit-replay-provenance.md) — fit-time provenance guards for `cross_validate` / ephemeral `fit_model` per-call cells (ROADMAP § Reproducibility). Not a new tool; lands as amendments to SPEC §5.11 / §5.11d / §6.
