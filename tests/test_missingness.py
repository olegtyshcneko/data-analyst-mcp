...
def test_M3b_mcar_suggestion_fires_between_30_and_50_pct_null(call_tool, load_df_into_session):
    ...
    assert any("mean-imputation will bias `y`" in s for s in result["suggestions"]), result[
        "suggestions"
    ]
